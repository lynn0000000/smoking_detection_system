...
-- 建立測試用戶 (密碼: admin123)
-- 注意: 實際部署時請刪除此測試帳號或修改密碼
INSERT INTO users (username, email, hashed_password, full_name, is_admin) VALUES
('admin', 'admin@example.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5XOOtFfWtRLO6', '系統管理員', TRUE);

-- 顯示建立完成訊息
SELECT '✅ 資料庫初始化完成！' AS message;
SELECT '📝 測試帳號: admin / admin123' AS info;
